...
Start:
    ...
    push Game.UI.View.COLOR_TITLE
    push 15
    push 1
    push Game.UI.View.sTitle
    call Display.Public.PrintString

    push Game.UI.View.COLOR_STICKS_EASY_LEVEL
    push 1
    push 3
    push 0
    push 12
    ...
    push 4
    call Game.UI.View.Public.ConfigureGameScreen
    ...
    push Game.UI.View.COLOR_STICKS_MEDIUM_LEVEL
    push 3
    call Display.Public.DrawSticks
    call Keyboard.Public.ReadKey

    push Game.UI.View.COLOR_STICKS_HARD_LEVEL
    push 2
    call Display.Public.DrawSticks
    call Keyboard.Public.ReadKey

    push Game.UI.View.COLOR_STICKS_TWO_PLAYERS
    push 1
    call Display.Public.DrawSticks
    call Keyboard.Public.ReadKey
